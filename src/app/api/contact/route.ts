...
export async function POST(request: Request) {
  try {
    ...
    const { data, error } = await resend.emails.send({
      from: 'Brique Developers <info@briquedevelopers.com>',
      to: ['info@briquedevelopers.com'],
      replyTo: email, // Allows you to reply directly to customer
      subject: 'New enquiry – Brique Developers',
      html: `
      <p>Hello,</p>
...
<strong>Service:</strong> ${service.replace('-', ' ')}</p>

<p><strong>Message:</strong><br/>
${message}</p>

<p>Regards,<br/>
Brique Developers<br/>
Ghaziabad, India<br/>
https://briquedevelopers.com</p>
`,
        // <!DOCTYPE html>
        // <html lang="en">
        //   <head>
